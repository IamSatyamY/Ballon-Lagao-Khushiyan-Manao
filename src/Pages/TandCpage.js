...
const TandCpage = () => {
  return (
    <div className='container text-justify'>
        ...
        <p>This site is owned by Whaleman Advertising (The Magic Balloons Store) . No material from this site or any other website owned, operated, controlled or licensed by TMBS  and/or its associates or its sister concerns may be copied, reproduced, republished, transmitted, downloaded, uploaded or in any other manner for commercial use or otherwise without the written permission of the TMBS. Violation of this condition is a violation of copyright and other proprietary rights of the Company and/or its associates or sister concerns or affiliates</p>
        ...
        <p>Users who have availed services through www.themagicballoons.store by selecting one or more listed service providers: www.themagicballoons.store reaches out to these users via SMS / E-mail / Call / Whats App messages Online after their scheduled appointment schedule and ask them for Feedback on their experience or inform them on the latest product updates from the Service provider. www.themagicballoons.store has complete ownership of this flow of feedback collection</p>
        ...
        <p>If the user has any questions, doubts or confusion in regard to any of the terms & conditions set out herein, he should seek clarifications from us through email (info@themagicballoons.com) and should wait for a written clarification before using the service</p>
